...
class AIConversationWidget(QWidget):
    ...
    def __init__(self, mode="chat"):
        ...
        self.header = ChatHeader(
            title=self.titles.get(self.mode, "🦉 Athena AI"),
    ...
    def send(self):
        ...
        # Future-proof:
        # We keep the current service signature.
        # Later we'll pass self.mode too.
    ...
    def on_response(self, response):
        ...
        if self.current_ai_bubble:
            self.current_ai_bubble.set_text(str(response))
